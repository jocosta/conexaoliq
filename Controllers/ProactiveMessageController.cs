...
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            Task.Factory.StartNew(async () =>
            {
                ...
                foreach (var item in service.GetRecipients())
                {
                    ...
                    ThumbnailCard thumbnailCard = new ThumbnailCard("Pesquisa de Satisfação", "", $"Gostariamos de saber sua opnião sobre a conexão. Por favor, reserve um tempinho para responder nossa pesquisa de satisfação",
                        null,
                        new List<CardAction> {
